...
<section class="dbf-page-hero">
	<img class="dbf-page-hero-bg" src="<?php echo esc_url( doughboss_final_asset_url( 'doughboss-feast-real-v1.jpg' ) ); ?>" alt="" width="1080" height="864" fetchpriority="high">
...
<section class="dbf-section dbf-section--dark"><div class="dbf-wrap dbf-story-grid">
	...
	<div class="dbf-story-media" data-dbf-reveal data-dbf-reveal-delay="1"><img src="<?php echo esc_url( doughboss_final_asset_url( 'menu/real-v1/meat-cheese.jpg' ) ); ?>" alt="Real Dough Boss meat and cheese manoush" width="900" height="720" loading="lazy" decoding="async"></div>
</div></section>
