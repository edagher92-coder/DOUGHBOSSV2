# DoughBoss Deploy 2.36.0 (PclZip)
...
This build intentionally uses the unique one-level plugin slug `doughboss-deploy-2360-pclzip/doughboss-deploy-2360-pclzip.php`. It may be installed beside a malformed or inactive older updater copy without replacing or loading that copy.
