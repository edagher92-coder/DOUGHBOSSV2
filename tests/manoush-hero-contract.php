...
hero_ok( false !== strpos( $php, 'width="258" height="258" loading="eager" decoding="async"' ), 'WordPress hero reserves mobile image space' );
...
hero_ok( false !== strpos( $demo_js, 'explodeHoldMs = 1150' ) && false !== strpos( $demo_js, "classList.remove('is-exploded')" ), 'demo holds the explosion before assembly' );
