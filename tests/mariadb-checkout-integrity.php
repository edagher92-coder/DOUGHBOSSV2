...
checkout_db_ok( '1.23.0' === get_option( 'doughboss_db_version' ), 'clean 1.12 fixture advances through current checkout, rewards, staff attendance, QR kiosk and voucher reconciliation storage' );
