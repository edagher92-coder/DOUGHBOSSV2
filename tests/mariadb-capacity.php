...
mariadb_ok( '1.23.0' === get_option( 'doughboss_db_version' ), '1.11 fixture advances through current transactional storage including rewards, staff attendance, QR kiosk and voucher reconciliation storage' );
