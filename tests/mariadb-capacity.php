...
mariadb_ok( '1.18.0' === get_option( 'doughboss_db_version' ), '1.11 fixture advances through capacity, checkout, table-QR, payment-attempt, POSPal-reference, Stripe-recovery, and menu-rename migrations' );
