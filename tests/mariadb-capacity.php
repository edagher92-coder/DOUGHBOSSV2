...
mariadb_ok( '1.16.0' === get_option( 'doughboss_db_version' ), '1.11 fixture advances through capacity, checkout, table-QR, payment-attempt, and POSPal-reference migrations' );
