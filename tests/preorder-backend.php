...
preorder_ok( false !== strpos( $files['admin'], "'screenMode' => \$screen_mode" ) && false !== strpos( $files['board'], "cfg.screenMode === 'make'") && false !== strpos( $files['board'], "cfg.screenMode === 'pass'" ), 'KDS supports dedicated MAKE and PASS touch-screen modes without changing its access boundary' );
