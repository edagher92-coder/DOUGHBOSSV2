...
const files = ['style.css', 'index.php', 'functions.php', 'header.php', 'footer.php', 'front-page.php', 'page-menu.php', 'page-order.php', 'page-track-order.php', 'page-catering.php', 'README.md'];
let failed = false;
