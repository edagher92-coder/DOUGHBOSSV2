...
- **Current code release:** plugin `2.29.1` / DB `1.17.0`. This is code-verified pending final CI; do not infer that production WordPress is running it until the live site responds and the installed version is checked.
...
Current consolidated release contract: plugin `2.29.1`, database schema `1.17.0`.
