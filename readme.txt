...
= 2.26.0 =
* Add a staff clock-in / clock-out portal with large touch-friendly controls, individual-account protection and manager timesheets.
* Add the dedicated staff clock capability to Kitchen, Manager and Administrator roles without altering customer ordering, payments or voucher access.
